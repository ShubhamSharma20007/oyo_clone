  ...
  return (
    ...
    <div className=" p-5">
        ...
        <div className="grid grid-cols-5  my-5 mx-20">
            ...
            <input type="text" value={city} onChange={(e)=>setCity(e.target.value)} className=' h-16 outline-none col-span-2  border-2 ' id="cityInput" placeholder='Search by city, hotel, or neighborhood' required
            />
