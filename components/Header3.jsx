  ...
  return (
    ...
    <div className=" p-5">
        ...
        <div className="grid grid-cols-5  my-5 mx-20">
            <input type="text" className=' h-16 outline-none col-span-2  border-2 ' placeholder='Search by city, hotel, or neighborhood' />
...
<button type="submit" className='col-span-1 bg-green-500 hover:bg-green-500 hover:cursor-pointer text-xl text-white'><Link href={`/hotels?location=Alwar`}>Search</Link>  </button>
